Shader "Custom/Toon"
{
    ...
    SubShader
    {
        ...
        #pragma surface surf CelShade fullforwardshadows vertex:vert
                               ...
                               float shadowAttenuation)
        {
            ...
            half4 lighting = half4(lightIntensity*1.1, lightIntensity,
                                   lightIntensity + blueShift, 1.0);
            return half4(s.Albedo.xyz, 1.0)*lighting;
        }
